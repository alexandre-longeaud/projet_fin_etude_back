...
{
    /**
     * @Route("/", name="app_back_office_user_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="app_back_office_user_new", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_back_office_user_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="app_back_office_user_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name="app_back_office_user_delete", methods={"POST"})
     */
